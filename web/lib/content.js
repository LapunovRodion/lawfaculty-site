...
export const getDepartmentBySlug = async (locale, slug) => {
  const payload = await strapiFetch('/api/departments', {
    ...
    'populate[persons][populate][publications][fields][0]': 'title',
    'populate[persons][populate][publications][fields][1]': 'year',
    'populate[persons][populate][publications][fields][2]': 'source',
    'populate[persons][populate][publications][fields][3]': 'url',
...
export const getPersons = async (locale, pageSize = 100) => {
  const payload = await strapiFetch('/api/persons', {
    ...
    'populate[publications][fields][1]': 'year',
    'populate[publications][fields][2]': 'source',
    'populate[publications][fields][3]': 'url',
